...
from watserface import curl_builder, logger, process_manager, state_manager, wording
from watserface.filesystem import get_file_name, get_file_size, is_file, remove_file
from watserface.hash_helper import validate_hash
from watserface.types import Commands, DownloadProvider, DownloadSet
...
def resolve_download_url_by_provider(download_provider : DownloadProvider, base_name : str, file_name : str) -> Optional[str]:
	download_provider_value = watserface.choices.download_provider_set.get(download_provider)
