...
from watserface.common_helper import create_float_metavar
...
from watserface.face_helper import paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
from watserface.face_masker import create_box_mask
...
from watserface.processors.live_portrait import create_rotation, limit_euler_angles, limit_expression
from watserface.processors.types import FaceEditorInputs, LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitRotation, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
...
from watserface.types import ApplyStateItem, Args, DownloadScope, Face, FaceLandmark68, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from watserface.vision import read_image, read_static_image, write_image
...
def process_frame(inputs : FaceEditorInputs, skip_cache : bool = False) -> VisionFrame:
