...
from watserface import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, process_manager, state_manager, video_manager, wording
from watserface.face_analyser import get_many_faces, get_one_face
from watserface.face_helper import warp_face_by_face_landmark_5
...
from watserface.filesystem import in_directory, same_file_extension
from watserface.processors import choices as processors_choices
from watserface.processors.types import FaceDebuggerInputs
from watserface.program_helper import find_argument_group
from watserface.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		watserface.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
...
def process_frame(inputs : FaceDebuggerInputs, skip_cache : bool = False) -> VisionFrame:
