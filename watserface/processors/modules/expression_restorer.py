...
import watserface.jobs.job_manager
import watserface.jobs.job_store
import watserface.processors.core as processors
from watserface import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, video_manager, wording
from watserface.common_helper import create_int_metavar
...
from watserface.face_helper import paste_back, warp_face_by_face_landmark_5
from watserface.face_masker import create_box_mask, create_occlusion_mask
from watserface.face_selector import find_similar_faces, sort_and_filter_faces
from watserface.face_store import get_reference_faces
from watserface.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from watserface.processors import choices as processors_choices
from watserface.processors.live_portrait import create_rotation, limit_expression
from watserface.processors.types import ExpressionRestorerInputs, LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
from watserface.program_helper import find_argument_group
from watserface.thread_helper import conditional_thread_semaphore, thread_semaphore
from watserface.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from watserface.vision import read_image, read_static_image, read_video_frame, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		watserface.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor' ])
...
def process_frame(inputs : ExpressionRestorerInputs, skip_cache : bool = False) -> VisionFrame:
