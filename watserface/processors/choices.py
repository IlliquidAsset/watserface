...
from watserface.common_helper import create_float_range, create_int_range
from watserface.filesystem import get_file_name, resolve_file_paths, resolve_relative_path
from watserface.processors.types import AgeModifierModel, DeepSwapperModel, ExpressionRestorerModel, FaceDebuggerItem, FaceEditorModel, FaceEnhancerModel, FaceSwapperModel, FaceSwapperSet, FrameColorizerModel, FrameEnhancerModel, LipSyncerModel
...
face_swapper_set : FaceSwapperSet =\
{
	...
	'hybrid_inswapper_simswap': [ '512x512', '768x768', '1024x1024' ],
