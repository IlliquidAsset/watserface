...
from watserface import core, state_manager
from watserface.cli_helper import render_table
from watserface.download import conditional_download, resolve_download_url
from watserface.filesystem import get_file_extension
from watserface.types import BenchmarkCycleSet
from watserface.vision import count_video_frame_total, detect_video_fps, detect_video_resolution, pack_resolution
...
def run() -> Generator[List[BenchmarkCycleSet], None, None]:
	...
	benchmarks = []
	target_paths = [watserface.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in watserface.choices.benchmark_set]
