...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(watserface.choices.execution_queue_count_range),
		minimum = watserface.choices.execution_queue_count_range[0],
		maximum = watserface.choices.execution_queue_count_range[-1]
	)
