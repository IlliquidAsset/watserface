...
from watserface import identity_profile, logger, process_manager, state_manager, wording
from watserface.audio import create_empty_audio_frame, get_audio_frame
from watserface.common_helper import get_first
from watserface.content_analyser import analyse_frame
from watserface.core import conditional_append_reference_faces
from watserface.face_analyser import get_average_face, get_many_faces
from watserface.face_selector import sort_faces_by_order
from watserface.face_store import clear_reference_faces, clear_static_faces, get_reference_faces
from watserface.filesystem import filter_audio_paths, is_image, is_video
from watserface.processors.core import get_processors_modules
from watserface.types import AudioFrame, Face, FaceSet, VisionFrame
from watserface.uis.core import get_ui_component, get_ui_components, register_ui_component
from watserface.uis.types import ComponentOptions
from watserface.vision import count_video_frame_total, detect_frame_orientation, normalize_frame_color, read_static_image, read_static_images, read_video_frame, restrict_frame


def get_source_face_for_preview() -> Optional[Face]:
...
def listen() -> None:
	...
	# Listen to identity profile changes
	source_profile_dropdown = get_ui_component('source_profile_dropdown')
	if source_profile_dropdown:
		source_profile_dropdown.change(clear_and_update_preview_image, inputs = PREVIEW_FRAME_SLIDER, outputs = PREVIEW_IMAGE)
