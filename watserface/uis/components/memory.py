...
from watserface.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = watserface.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(watserface.choices.system_memory_limit_range),
		minimum = watserface.choices.system_memory_limit_range[0],
		maximum = watserface.choices.system_memory_limit_range[-1],
